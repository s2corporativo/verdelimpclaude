    ...
    <table style={{borderCollapse:"collapse",width:"100%",background:"#fff",border:"1px solid #e5e7eb",borderRadius:12,overflow:"hidden"}}>
      ...
      <tbody>{data.map((e:any)=>(
        <tr key={e.id} style={{borderBottom:"1px solid #f3f4f6"}}>
          ...
          <td style={{padding:"8px 12px",fontWeight:700,color:"#4a9410"}}>R${fmt(Number(e.salary))}</td>
      ...
      <tfoot><tr style={{background:"#e8f5ee"}}>
        <td colSpan={2} style={{padding:"9px 12px",fontWeight:700,fontSize:12,color:"#334532"}}>TOTAIS</td>
        <td style={{padding:"9px 12px",fontWeight:700,color:"#4a9410"}}>R${fmt(folha)}</td>
